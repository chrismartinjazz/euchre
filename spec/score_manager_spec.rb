...
RSpec.describe ScoreManager do
  ...
  describe '#update_score' do
    it 'processes result and adds the correct score to team 2' do
      ...
      context.result = OpenStruct.new(winner: team2, points: 1)
    ...
    it 'processes result and adds the correct score to team 2' do
      ...
      context.result = OpenStruct.new(winner: team1, points: 4)
  ...
  describe '#game_over' do
    ...
    it 'correctly identifies when the game is over' do
      context.score = { team1 => ScoreManager::POINTS_TO_WIN_GAME, team2 => 2 }

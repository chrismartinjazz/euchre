...
module Euchre
  ...
  RSpec.describe Players::HumanPlayer do
    let(:human_player_bidding) { instance_double(Players::HumanPlayerBidding) }
    let(:human_player_tricks) { instance_double(Players::HumanPlayerTricks) }
    let(:player) { Players::HumanPlayer.new(name: 'player', bidding: human_player_bidding, tricks: human_player_tricks) }

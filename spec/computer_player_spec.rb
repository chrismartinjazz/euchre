...
module Euchre
  RSpec.describe Players::ComputerPlayer do
    let(:computer_player_bidding) { instance_double(Players::ComputerPlayerBidding) }
    let(:computer_player_tricks) { instance_double(Players::ComputerPlayerTricks) }
    let(:player) { Players::ComputerPlayer.new(name: 'player', bidding: computer_player_bidding, tricks: computer_player_tricks)}
